...
class CloudScanDbSerializer(serializers.Serializer):
...
class CloudScanResultsDbSerializer(serializers.Serializer):
    scan_id = serializers.UUIDField(required=True, help_text=("Provide ScanId"))
    rescan_id = serializers.CharField(read_only=True)
    project_id = serializers.UUIDField(read_only=True)
    date_time = serializers.DateTimeField(read_only=True)
    ...
    resourceName = serializers.CharField(read_only=True)
    resourceId = serializers.CharField(read_only=True)
    cloudType = serializers.CharField(read_only=True)
    cloudAccountId = serializers.CharField(read_only=True)
