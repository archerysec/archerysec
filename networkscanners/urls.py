...
urlpatterns = [
    ...
    path("vul_details/", views.scan_vul_details, name="vul_details"),
    path("launch_scan/", views.launch_scan, name="launch_scan"),
    path("scan_del/", views.scan_del, name="scan_del"),
    ...
    path("vuln_check/", views.vuln_check, name="vuln_check"),
    path("OpenVAS_xml_upload/", views.OpenVAS_xml_upload, name="OpenVAS_xml_upload"),
